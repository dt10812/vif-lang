    ...
    <footer className="bg-neutral-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between mb-8">
          <div className="mb-6 md:mb-0">
            ...
            <p className="max-w-xs text-gray-400">
              Revolutionary atmospheric electricity generation technology for a
              sustainable future.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8 mt-8 text-center text-gray-500 text-sm">
          <p>
            &copy; {new Date().getFullYear()} AtmosPower Technology. All rights
            reserved.
          </p>
          <p className="mt-2">
            Atmospheric electricity generation project for educational and
            research purposes.
          </p>
        </div>
      </div>
