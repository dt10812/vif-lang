        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              From emergency power generation to everyday applications, our
              technology provides sustainable electricity in innovative ways.
            </p>
          </motion.div>
            ...
            <SolutionCard
              ...
              svgContent={
                ...
                >
                  ...
                  {/* Hills */}
                  <path
                    d="M0,100 Q100,50 200,100 Q300,150 400,100 L400,200 L0,200 Z"
                    fill="#81C784"
                    opacity="0.7"
                  />
                  ...
                  {/* Energy Flow */}
                  <path
                    d="M265,130 Q250,130 230,130"
                    stroke="#FFEB3B"
                    strokeWidth="2"
                    strokeDasharray="5,3"
                  />
                  <path
                    d="M265,140 Q250,140 230,140"
                    stroke="#FFEB3B"
                    strokeWidth="2"
                    strokeDasharray="5,3"
                  />
            ...
            <SolutionCard
              ...
              svgContent={
                ...
                >
                  ...
                  {/* Emergency Tent */}
                  <polygon
                    points="100,150 150,100 250,100 300,150"
                    fill="#FFFFFF"
                    stroke="#D32F2F"
                    strokeWidth="2"
                  />
                  <polygon
                    points="100,150 150,100 200,100 150,150"
                    fill="#FFCDD2"
                  />
                  <line
                    x1="175"
                ...
                >
                  ...
                  <g fill="#388E3C">
                    {[40, 80, 120, 160, 200, 240, 280, 320, 360].map((x, i) => (
                      <path
                        key={i}
                        d={`M${x},140 Q${x - 5},130 ${x -
                          10},120 M${x},140 Q${x + 5},130 ${x + 10},120`}
                        stroke="#388E3C"
                        strokeWidth="2"
                      />
                    ))}
                    {[40, 80, 120, 160, 200, 240, 280, 320, 360].map((x, i) => (
                      <path
                        key={i}
                        d={`M${x},160 Q${x - 5},150 ${x -
                          10},140 M${x},160 Q${x + 5},150 ${x + 10},140`}
                        stroke="#388E3C"
                        strokeWidth="2"
                      />
                    ))}
            ...
            <SolutionCard
              ...
              svgContent={
                ...
                >
                  ...
                  {/* Circuit Traces */}
                  <path
                    d="M50,50 H350 M50,100 H350 M50,150 H350 M100,50 V150 M200,50 V150 M300,50 V150"
                    stroke="#0288D1"
                    strokeWidth="1"
                    fill="none"
                    strokeDasharray="5,5"
                  ...
                  <g transform="translate(200,30)">
                    ...
                    {/* Energy Flow */}
                    <path
                      d="M-30,15 V40 H-100 V100 M0,15 V40 H0 V60 M30,15 V40 H100 V100"
                      stroke="#FFEB3B"
                      strokeWidth="2"
                      strokeDasharray="5,3"
                    />
            ...
            <SolutionCard
              ...
              svgContent={
                ...
                >
                  ...
                  <path
                    d="M0,150 Q100,100 200,150 Q300,100 400,150 L400,200 L0,200 Z"
                    fill="#81C784"
                    opacity="0.5"
                  />
                  <path
                    d="M300,150 L350,70 L400,150"
                    fill="#795548"
                    opacity="0.8"
                  />
                  <circle
                  ...
                  {/* Backpack */}
                  <path
                    d="M150,100 V160 H200 V100 Q175,90 150,100 Z"
                    fill="#795548"
                    stroke="#5D4037"
                    strokeWidth="1"
                  />
            ...
            <div className="flex flex-col md:flex-row">
              <div className="md:w-1/3 mb-6 md:mb-0">
                <div className="rounded-lg overflow-hidden">
                  <svg viewBox="0 0 400 300" className="w-full h-auto">
                    ...
                    />
                    <path
                      d="M0,150 Q100,120 200,150 Q300,120 400,150"
                      fill="none"
                      stroke="#81C784"
                      strokeWidth="2"
                    />
              ...
              <div className="md:w-2/3 md:pl-8">
                <h3 className="font-heading text-2xl font-bold text-primary mb-4">
                  Case Study: Puerto Rico Recovery Project
                </h3>
                <p className="mb-4">
                  Following the devastation of Hurricane Maria, we deployed 50
                  prototype atmospheric generators to communities with damaged
                  power infrastructure. These units provided essential
                  electricity for:
                </p>
                ...
                <p>
                  The success of this pilot program demonstrated the real-world
                  potential of our technology in disaster recovery scenarios and
                  has led to partnerships with multiple humanitarian
                  organizations.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We're actively working to overcome these challenges to bring our
              technology to scale.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card>
              <CardContent className="p-6">
                ...
                <p>
                  Current prototypes generate relatively low power compared to
                  solar or wind. We're researching enhanced nanowire
                  formulations and optimized array configurations to
                  significantly increase power output per square meter.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p>
                  Manufacturing protein nanowires at scale presents unique
                  challenges. We're developing bioreactor systems that can
                  produce large quantities of the specialized bacteria and
                  extract their nanowires efficiently.
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-start mb-4">
                  <div className="bg-primary/10 p-3 rounded-full mr-4">
                    ...
                    >
                      <path
                        d="M2 12H6M18 12H22M12 2V6M12 18V22M4.93 4.93L7.76 7.76M16.24 16.24L19.07 19.07M4.93 19.07L7.76 16.24M16.24 7.76L19.07 4.93"
                        stroke="currentColor"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                <p>
                  Ensuring long-term stability in various environmental
                  conditions is crucial. We're developing protective
                  encapsulation technologies that shield the nanowires while
                  still allowing efficient moisture transfer from the air.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p>
                  Introducing a fundamentally new energy technology requires
                  education and awareness. We're developing demonstration kits
                  and educational materials that clearly explain the technology
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto mb-12">
            Connect with our team to discuss how atmospheric electricity
            generation can benefit your project, community, or organization.
          </p>
